...
| Cloud sync, accounts, analytics, telemetry endpoint | Every one of them breaks £0/no-server or the privacy promise. JSON backup answers 95% of the underlying need |
